      ...
      <View style={[styles.container, { backgroundColor: colors.background }]}>
        ...
        <View style={[styles.header, { backgroundColor: colors.surface }]}>
          ...
          <View style={styles.headerTitleContainer}>
            ...
            <Text style={[styles.headerTitle, { color: colors.text }]}>{t('cart')}</Text>
          </View>
          <TouchableOpacity
        ...
        {items.length > 0 ? (
            ...
            ListFooterComponent={
              <>
                <View style={[styles.summary, { backgroundColor: colors.surface }]}>
                  ...
                  <View style={styles.summaryRow}>
                    <Text style={[styles.summaryLabel, { color: colors.text }]}>{t('shipping')}</Text>
                    <Text style={[styles.summaryValue, { color: colors.text }]}>₹{Math.round(shipping)}</Text>
                  </View>
                  <View style={styles.summaryRow}>
                    <Text style={[styles.summaryLabel, { color: colors.text }]}>{t('tax')}</Text>
                  ...
                  <View style={[styles.totalRow, { borderTopWidth: 1, borderTopColor: colors.textSecondary }]}>
                    <Text style={[styles.totalLabel, { color: colors.text, fontWeight: 'bold' }]}>{t('total')}</Text>
                ...
                <View style={styles.checkoutContainer}>
                  <TouchableOpacity
                    ...
                    <Text style={[styles.checkoutButtonText, { color: colors.onPrimary }]}>{t('checkout')}</Text>
                  </TouchableOpacity>
                </View>
              </>
            }
          ...
          <View style={styles.emptyContainer}>
            <Text style={[styles.emptyText, { color: colors.textSecondary }]}>{t('cart_empty')}</Text>

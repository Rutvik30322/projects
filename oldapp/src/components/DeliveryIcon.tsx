...
const DeliveryIcon: React.FC<DeliveryIconProps> = ({ size = 24, focused = false, color }) => {
  ...
  return (
    <Svg width={size} height={size} viewBox="0 0 128 128">
      <G>
        {/* Delivery truck and details */}
        <Path
          d="M34.212,73.029c-0.265-0.029-0.51,0.167-0.54,0.432l-0.059,0.491
          ...
          v1.963h15.702v-1.963H10.795z M4.907,59.692v1.963h23.701v-1.963H4.907z"
          fill={iconColors.fill}
        />
        
        {/* Right wheel */}
        <Path
          d="M112.253,76.817c-4.406,0-7.989,3.582-7.989,7.989c0,4.397,3.582,7.979,7.989,7.979
          ...
          C118.269,88.123,115.57,90.822,112.253,90.822z"
          fill={iconColors.fill}
        />
        
        {/* Main truck body */}
        <Path
          d="M127.16,76.562c0.687-0.697,0.981-1.698,0.775-2.66
          ...
          c0-2.689-0.726-5.241-2.1-7.449c0.059,0.01,0.108,0.02,0.167,0.029C125.482,77.573,126.473,77.269,127.16,76.562z"
          fill={iconColors.fill}
        />
        
        {/* Left wheel */}
        <Path
          d="M49.099,96.062c-6.202,0-11.257-5.054-11.257-11.257c0-1.109,0.157-2.188,0.471-3.229h3.494
          ...
          C45.782,90.822,43.084,88.123,43.084,84.806z"
          fill={iconColors.fill}
        />
        
        {/* Truck body details */}
        <Path
          d="M93.94,78.633H31.11c0.481-4.318,2.444-16.478,9.529-21.777h29.727
          ...
          c-0.373-0.844-8.155-18.892-10.766-24.79l0.962-0.265l9.333,16.301l5.211,9.5L93.94,78.633z"
          fill={iconColors.fill}
        />
        ...
        <Path
          d="M35.33,31.938h35.429v2.875H35.33V31.938z M35.33,51.517V36.776h15.182v5.977h4.289
          v-5.977h15.958v14.741H35.33z"
          fill={iconColors.fill}
        />
      </G>
    </Svg>

...
const SearchIcon: React.FC<SearchIconProps> = ({ size = 24, color }) => {
  ...
  return (
    <Svg width={size} height={size} viewBox="0 0 128 128">
      <G>
        <Path
          d="M46.872,93.337c-25.389,0-46.051-20.931-46.06-46.657C0.806,34.275,5.577,22.579,14.246,13.746
        ...
        />
        <Path
          d="M46.875,82.332c-9.397,0-18.239-3.716-24.896-10.464c-6.651-6.742-10.311-15.69-10.307-25.197
        ...
        />
        <Path
          d="M27.985,46.667l-4-0.001c0.001-6.168,2.373-11.979,6.678-16.36c4.338-4.414,10.103-6.845,16.232-6.845v4
        ...
        <G>
          ...
          />
          <Path
            d="M114.221,128c-1.706,0-3.401-0.348-5.037-1.035l-0.368-0.154L77.84,95.417l17.168-17.394l31.011,31.424
          ...
          <Rect
            x="93.977"
            y="88.513"
            transform="matrix(0.712 0.7022 -0.7022 0.712 95.3379 -39.6291)"
            fill={iconColor}
            width="4"
            height="15.777"
          />
          <Rect
            x="77.307"
            y="81.125"
            transform="matrix(0.7023 0.7119 -0.7119 0.7023 83.845 -34.2517)"
            fill={iconColor}
            width="11.138"
            height="4"
          />

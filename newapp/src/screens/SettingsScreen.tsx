...
const SettingsScreen: React.FC<{ navigation: any }> = ({ navigation }) => {
  ...
  const settingsOptions = [
    ...
    { id: '3', title: 'Theme Settings', iconType: 'theme', screen: 'ThemeSettings' },
    { id: '4', title: 'Help & Support', iconType: 'help', screen: 'HelpSupport' },
    { id: '5', title: 'About', iconType: 'about', screen: 'About' },
  ];

/// <summary>
/// Encrypt/Decrypt important data.
/// </summary>
namespace NEncryptDecrypt
{
    ...
    public class EncryptDecrypt
    {
        ...
        public static string GetConnString()
        {
            ...
            //string encryptPwd = EncryptDecrypt.Encrypt(pwd);
            string dencryptPwd = EncryptDecrypt.Decrypt(pwd);
        ...
        /// </summary>
        /// <returns></returns>
        public static string GetConnString(string fileName = null)
        {
            string path = AppDomain.CurrentDomain.BaseDirectory;
            string conStr = null;
            XmlDocument xmldoc = new XmlDocument();
            ...
            if (fileName == null)
            {
                fs = new FileStream(path + "\\DataBaseConfig.xml", FileMode.Open, FileAccess.Read);
            }
            else
            {
